...
class Atri:
	def __init__(self, state: Any):
		...
		self.outer_header = state["outer_header"]
		self.inner_header = state["inner_header"]
		self.header_left = state["header_left"]
		self.logo_Container = state["logo_Container"]
		self.navigation_container = state["navigation_container"]
		self.right_flex = state["right_flex"]
		self.Flex5 = state["Flex5"]
		self.Div4 = state["Div4"]
		self.Flex6 = state["Flex6"]
		self.Div5 = state["Div5"]
		self.order_section = state["order_section"]
		self.order_apps_container = state["order_apps_container"]
		self.Div8 = state["Div8"]
		self.Div9 = state["Div9"]
		self.Div10 = state["Div10"]
		self.Div11 = state["Div11"]
		self.order_heading_container = state["order_heading_container"]
		...
		self.home_link = state["home_link"]
		...
		self.order_heading = state["order_heading"]
	...
	def outer_header(self):
		self._getter_access_tracker["outer_header"] = {}
		return self._outer_header
	@outer_header.setter
	def outer_header(self, new_state):
		self._setter_access_tracker["outer_header"] = {}
		global default_state
		self._outer_header = Flex(new_state, default_state["outer_header"])

	@property
	def inner_header(self):
		self._getter_access_tracker["inner_header"] = {}
		return self._inner_header
	@inner_header.setter
	def inner_header(self, new_state):
		self._setter_access_tracker["inner_header"] = {}
		global default_state
		self._inner_header = Flex(new_state, default_state["inner_header"])

	@property
	def header_left(self):
		self._getter_access_tracker["header_left"] = {}
		return self._header_left
	@header_left.setter
	def header_left(self, new_state):
		self._setter_access_tracker["header_left"] = {}
		global default_state
		self._header_left = Flex(new_state, default_state["header_left"])

	@property
	def logo_Container(self):
		self._getter_access_tracker["logo_Container"] = {}
		return self._logo_Container
	@logo_Container.setter
	def logo_Container(self, new_state):
		self._setter_access_tracker["logo_Container"] = {}
		global default_state
		self._logo_Container = Div(new_state, default_state["logo_Container"])

	@property
	def navigation_container(self):
		self._getter_access_tracker["navigation_container"] = {}
		return self._navigation_container
	@navigation_container.setter
	def navigation_container(self, new_state):
		self._setter_access_tracker["navigation_container"] = {}
		global default_state
		self._navigation_container = Div(new_state, default_state["navigation_container"])

	@property
	def right_flex(self):
		self._getter_access_tracker["right_flex"] = {}
		return self._right_flex
	@right_flex.setter
	def right_flex(self, new_state):
		self._setter_access_tracker["right_flex"] = {}
		global default_state
		self._right_flex = Flex(new_state, default_state["right_flex"])
	...
	@property
	def order_section(self):
		self._getter_access_tracker["order_section"] = {}
		return self._order_section
	@order_section.setter
	def order_section(self, new_state):
		self._setter_access_tracker["order_section"] = {}
		global default_state
		self._order_section = Flex(new_state, default_state["order_section"])

	@property
	def order_apps_container(self):
		self._getter_access_tracker["order_apps_container"] = {}
		return self._order_apps_container
	@order_apps_container.setter
	def order_apps_container(self, new_state):
		self._setter_access_tracker["order_apps_container"] = {}
		global default_state
		self._order_apps_container = Flex(new_state, default_state["order_apps_container"])
	...
	@property
	def order_heading_container(self):
		self._getter_access_tracker["order_heading_container"] = {}
		return self._order_heading_container
	@order_heading_container.setter
	def order_heading_container(self, new_state):
		self._setter_access_tracker["order_heading_container"] = {}
		global default_state
		self._order_heading_container = Flex(new_state, default_state["order_heading_container"])
	...
	@property
	def home_link(self):
		self._getter_access_tracker["home_link"] = {}
		return self._home_link
	@home_link.setter
	def home_link(self, new_state):
		self._setter_access_tracker["home_link"] = {}
		global default_state
		self._home_link = Link(new_state, default_state["home_link"])
	...
	@property
	def order_heading(self):
		self._getter_access_tracker["order_heading"] = {}
		return self._order_heading
	@order_heading.setter
	def order_heading(self, new_state):
		self._setter_access_tracker["order_heading"] = {}
		global default_state
		self._order_heading = TextBox(new_state, default_state["order_heading"])
	...
	def _to_json_fields(self):
		return {
			"outer_header": self._outer_header,
			"inner_header": self._inner_header,
			"header_left": self._header_left,
			"logo_Container": self._logo_Container,
			"navigation_container": self._navigation_container,
			"right_flex": self._right_flex,
			"Flex5": self._Flex5,
			"Div4": self._Div4,
			"Flex6": self._Flex6,
			"Div5": self._Div5,
			"order_section": self._order_section,
			"order_apps_container": self._order_apps_container,
			"Div8": self._Div8,
			"Div9": self._Div9,
			"Div10": self._Div10,
			"Div11": self._Div11,
			"order_heading_container": self._order_heading_container,
			"Flex8": self._Flex8,
			"Flex27": self._Flex27,
			"Flex32": self._Flex32,
			"Div15": self._Div15,
			...
			"Image8": self._Image8,
			"Image9": self._Image9,
			"order_heading": self._order_heading,
